...
public class BariwalaSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bariwala_settings);
        ...
        mBariwalaDatabase = FirebaseDatabase.getInstance().getReference().child("Users").child("Bariwala").child(userID);
